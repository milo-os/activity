...
import (
	...
	activity "go.miloapis.com/activity/pkg/client/informers/externalversions/activity"
...
func (f *sharedInformerFactory) Activity() activity.Interface {
	return activity.New(f, f.namespace, f.tweakListOptions)
}
